...
const borrowerPhone = 'Please enter correct phone'
...
export const DebtSchema = yup.object().shape({
  ...
  borrowerPhone: yup.string().typeError(borrowerPhone).required(borrowerPhone).matches(phoneRegExp, borrowerPhone),
